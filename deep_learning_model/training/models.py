...
class Classifier(LightningModule):
    ...
    def prepare_data(self):
        self.trainset = datasets.ImageFolder(
            "../data/images_splited_balanced_upscaled_team" + str(
                self.team) + "/train", transform=self.transform)
        self.valset = datasets.ImageFolder(
            "../data/images_splited_balanced_upscaled_team" + str(
                self.team) + "/val", transform=self.transform)
        self.testset = datasets.ImageFolder(
            "../data/images_splited_balanced_upscaled_team" + str(
                self.team) + "/test", transform=self.transform)
